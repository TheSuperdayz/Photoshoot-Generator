...
const IdeaCard: React.FC<{ idea: CreativeIdea }> = ({ idea }) => {
    ...
    return (
        <div 
          ...
          className="bg-slate-800/80 backdrop-blur-lg border border-slate-700 rounded-xl p-6 relative group transition-transform duration-100 ease-linear card-3d-tilt"
        >
        ...
        <main className="flex-grow container mx-auto p-4 md:p-8">
            <div className="w-full max-w-3xl mx-auto">
                ...
                <div className="text-center mb-10">
                    ...
                    <p className="mt-4 text-lg text-slate-400">Describe your product, brand, or a vague thought, and let our AI creative director brainstorm for you.</p>
                </div>
                ...
                <div>
                    {props.isLoading && props.generatedIdeas.length === 0 && (
                        <div className="flex flex-col items-center justify-center text-center py-16">
                            <LoadingSpinner />
                            <p className="text-lg text-slate-400 mt-4">Brainstorming in progress...</p>
                            <p className="text-sm text-slate-500">Our AI creative director is brewing up some fresh ideas!</p>
                        </div>
                    )}

                    {!props.isLoading && props.generatedIdeas.length === 0 && (
                        <div className="text-center py-16 bg-slate-800/50 rounded-2xl border-2 border-dashed border-slate-700">
                           <LightbulbIcon className="w-16 h-16 text-slate-600 mx-auto" />
                           <h3 className="mt-4 text-xl font-semibold text-slate-300">Your brilliant ideas will appear here</h3>
